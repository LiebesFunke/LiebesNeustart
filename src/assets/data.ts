...
export const features = [
  {
    ...
    description: 'Deine Daten werden niemals weitergegeben. Volle Diskretion, immer.',
  },
  {
    icon: 'badge-check' as const,
    title: 'Verifizierte Profile',
    description: 'Jedes Profil wird geprüft — keine Bots, keine Fake-Accounts.',
  },
  {
    icon: 'heart' as const,
    title: 'Gleichgesinnte Menschen',
    description:
      'Eine 40+ Community, die Vertrauen, Zeit und echte Gespräche schätzt.',
  },
  {
    icon: 'map-pin' as const,
    title: 'Treffen in deiner Nähe',
    description: 'Triff Frauen in deiner Umgebung — bereit für ein echtes Date.',
  },
] as const;
...
export const quizQuestions = [
  {
    ...
    options: [
      ...
      'Eine unverbindliche Romanze',
      'Einfach nur Spaß',
      'Ich bin mir noch nicht sicher',
    ],
  },
  {
    question: 'Welche Altersgruppe bevorzugst du?',
    options: ['35–45', '45–55', '55+', 'Keine Präferenz'],
  },
  {
    question: 'Wie weit bist du bereit zu reisen?',
    options: ['Bis 15 km', 'Bis 40 km', 'Bis 80 km', 'Egal wie weit'],
  },
  {
    question: 'Was ist dir am wichtigsten?',
    options: ['Ehrlichkeit', 'Gemeinsame Interessen', 'Körperliche Anziehung', 'Emotionale Verbindung'],
  },
  {
    question: 'Wie würdest du dich beschreiben?',
    options: ['Abenteuerlustig', 'Häuslich', 'Gesellig', 'Ruhig und nachdenklich'],
  },
  {
    question: 'Bereit, deine Matches zu sehen?',
    options: ['Ja, zeig sie mir!', 'Erzähl mir mehr', 'Vielleicht später', 'Noch unsicher'],
  },
] as const;
...
export const ui = {
  ...
  hero: {
    badge: 'Exklusive 40+ Community',
    titleBefore: 'Beginne ein',
    titleAccent: 'neues Kapitel',
    titleAfter: 'deiner Geschichte.',
    subtitle:
      'Lerne reife, verifizierte Frauen in deiner Nähe kennen. Keine Spielchen, kein Druck — nur echte Verbindungen.',
    cta: 'Deine Matches ansehen',
    verifiedProfiles: 'Verifizierte Profile',
    discreet: '100 % diskret',
    live: 'LIVE',
    womenOnline: 'Frauen gerade online',
    membersOnly: 'Nur für verifizierte Mitglieder',
    messageHer: 'Jetzt anschreiben',
  },
  howItWorks: {
    title: "So funktioniert's",
  },
  features: {
    title: 'Warum unsere Community anders ist',
    subtitle: 'Für reife Singles, die etwas Echtes suchen.',
  },
  cta: {
    title: 'Bereit für einen Neuanfang?',
    subtitle:
      'Mache das 60-Sekunden-Quiz und triff Frauen, die wirklich zu dir passen.',
